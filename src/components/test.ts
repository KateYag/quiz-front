...
import {setTestStore} from "../utils/test-store";
...
export class Test {
    ...
    private startQuiz(): void {
        ...
        if (this.prevButtonElement) {
            this.prevButtonElement.onclick = () => this.move.bind(ActionTestType.prev);
        }
   ...
   private async complete(): Promise<void> {
        ...
        try {
            setTestStore({ userResult: this.userResult });
